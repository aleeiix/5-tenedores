...
export default function ChangePasswordForm(props) {
  ...
  const updatePassword = () => {
    ...
    if (!password || !newPassword || !newPasswordRepeat) {
      ...
      let objError = {};
      !password && (objError.password = required);
      !newPassword && (objError.newPassword = required);
      !newPasswordRepeat && (objError.newPasswordRepeat = required);

      setError(objError);
    } else {
      if (newPassword !== newPasswordRepeat) {
        setError({
          newPassword: "Las nuevas contraseñas tienen que coincidir",
          newPasswordRepeat: "Las nuevas contraseñas tienen que coincidir"
        });
      } else {
        setIsLoading(true);
